 ...
 *     Header do driver b�sico de teclado para o Boot Loader.
 *
 * Obs:
 * O padr�o de teclado usado precisa ser revisto.
 * Pelo jeito estamos usando o padr�o americano. Mas � poss�vel adaptar para 
 * ABNT2 sem muitos problemas. @todo: Podemos copiar do driver do n�cleo.
 *
 * History:
...
//mensagens. 
//@todo: Algumas mensagens n�o s�o necess�rias para o bootloader.
...
//mensagens de janela
//@todo: Mensagens de janela n�o s�o necess�rias para o bootloader.
