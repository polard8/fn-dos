...
// De acordo com a porta, saberemos se � 
// primary ou secondary e se �
// master ou slave.
...
// ??
// O n�mero da porta identica qual disco queremos pegar informa��es.
// Slavaremos algumas informa��es na estrutura de disco.
...
int ide_identify_device ( uint8_t nport )
{
    ...
    // ent�o temos que nos certificar que esses valores 
    // s�o v�lidos.
    ...
    //
    // Solicitando informa��es sobre o disco.
    //
    ...
    // #todo
    // Use esses registradores para pegar mais informa��es.
    // See:
    ...
    */
    ...
    /*
    // #test
    // Isso provavelmente � o n�mero de setores envolvidos em
...
// #todo
// Agora essa fun��o precisa receber um ponteiro 
...
int ide_dev_init (char port)
{
    ...
    if ( data == 0 )
    {
        ...
        // Uma parte est� em 61 e outra em 60.
    ...
    // informa��es sobre a porta ide.
    // channel and device.
    // ex: primary/master.
    // #bugbug
    // Mas temos um problema. Talvez quando essa fun��o
    // foi chamada o dev_num ainda n�o tenha cido inicializado.
    //
...
int ata_initialize ( int ataflag )
{
    ...
    // #todo
    // Poderemos mudar o atual conforme nossa inten��o
...
fail:
    ...
    // Setup interrupt breaker.
    // S� liberamos se a inicializa��o fncionou.
