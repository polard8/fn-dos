...
int ps2_mouse_globals_initialize (void)
{
    ...
    // #bugbug. 
    // Cuidado com essa inicializa�ao.
    // #todo
...
// Temos que pegar isso logo ap�s o reset.
...
//__enable_second_port :
    ...
    // Mas antes da habilita��o temos uma rotina que n�o me lembro
    // pra que serve, haha.
    // #importante: 
    // TALVEZ. T� achando que essa rotina deva ser feita no 
    // teclado, apos seu reset, e n�o aqui no mouse.
    
    // #bugbug
    // Essa nao eh uma rotina de habilita�ao do dispositivo secundario,
    // estamos apenas lendo a porta 60 e devolvendo o que lemos o que lemos
    // com alguma modifica�ao;
    ...
    // Reenable mouse port.
    // #bugbug: a rotina de inicializa�ao da controladora ps2,
    // esta fazendo isso ao fim da rotina. nao precisamos fazer isso aqui.
    // Talvez atrapalhe a inicializa�ao.
    // 0xA8 Enable Mouse
    // 0xA7 Disable Mouse
...
*/
    ...
    // n�o precisamos de ack nesse caso.
...
//
    ...
    if ( (void *) __file == NULL ){
        ...
        // #importante
        // Essa � a tabela de montagem de dispositivos.
...
// O primeiro byte comt�m um monte de flags.
// O segundo byte comt�m o delta x
// O terceiro byte comt�m o delta y
...
void ps2mouse_parse_data_packet (void)
{
	...
	// Atualizando.
	// Essa fun��o esta nesse documento.
	...
	// 1 = ouve altera��o em rela��o ao estado anterior.
...
//
    ...
    // et�o mudamos essa flag e enviamos os dados do mouse para 
    //fila em sua thread.
    ...
    if ( wmPID > 0 && wmPID < PROCESS_COUNT_MAX )
    {
        ...
        // para mandar as informa��es de mouse ao wm.
        // Ent�o vamos mudar a flag.
        // Mudando a flag, o kernel n�o vai mais scanear as janelas
        // como fazia antes. Que por sinal ja n�o faz mais sentido mesmo.
	...
	// #obs: 
	// count_mouse � global. Provavelmente nesse arquivo mesmo.

    *_byte = (char) xxx_mouse_read();


    // #todo
    // Temos que checar se o primeiro byte � um ack ou um resend.
    // isso acontece logo apos a inicializa��o.
    ...
    switch (count_mouse){
        ...
        case 0:
            ...
            // mas o que impede os outros bytes de tamb�m terem?
        ...
        case 2:
            ...
            if ( IOControl.useEventQueue == TRUE )
            {
                ...
                //#todo:
                // n�o usaremos mais isso, pois n�o vamos escanear
                ...
                // e mandarmos somente as informa��es para o wm,
                // mas possivelmente o melhor a fazer � somente mandar os informa��es
                // para o window manager e deixar ele exibir,
                // mesmo que ele use o kernel para isso, o que me parece uma boa ideia.
                
                //#todo: deprecate
                // N�o temos um wm em ring3, usamos o de ring0.
                ...
                //#todo
                //pegar as informa��es que mandaremos para o
                //window manager,
                ...
                // ent�o vamos usar o window manager que esta em ring3.
                // Essas mensagens podem sobrecarregar a fila.
                // precisamso de uma solu��o elegante pra isso,
