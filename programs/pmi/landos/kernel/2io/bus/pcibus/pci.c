...
// Ent�o para uma IRQ destinada � PCI ter� que identificar 
// qual dispositivo gerou a interrup��o, 
 ...
 * usar�o o mesmo isr (handler). 
 *     Caber� � rotina do handler identificar qual dispositivo 
 * sinalizou que efetuou uma interrup��o. Ent�o direcionar 
...
{ 
    ...
    if ( (void *) D == NULL ){
        ...
        // #bugbug
        // Ver em que hora que os buffers s�o configurados.
