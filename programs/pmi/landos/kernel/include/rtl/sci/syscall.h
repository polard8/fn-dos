...
// bufbug: isso est� gastando mem�ria carregando o diret�rio raiz.
#define  SYS_178 178
...
// memory support.
// get page dir value.
// #debug: provevelmente pega o endere�o do diret�rio de p�ginas
// de um processo.
// Precisa de privil�gios. 
...
// #bugbug: 
// Isso provavelmente s�o rotinas de console virtual
// e n�o de pseudo terminal
