 ...
 *
 * Descri��o:
 *     >> header para o m�dulo ldisc do kernel base.
 *
 *     Header do driver de teclado presente dentro do kernel. 
 *     Manter aqui par�metros gerais, que possam ser �teis pra qualquer 
 * driver de teclado.
 *     Coisas como estrutura para identifica��o do modele, nome do driver,
 *      pathname do driver.
 *
 * Ambiente:
 *     Kernel mode (Ring 0).
...
//pega a pr�xima mensagem da fila fifo. circular.
#define LDISC_GET_NEXT_MESSAGE 9    

//pega o pr�ximo scancode da fila fifo. circular.
#define LDISC_GET_NEXT_SCANCODE 10  

//Um endere�o em usermode espera pelos 4 argumentos da mensagem.	
...
//
// @todo: Sondando scancode. (provis�rio.)
//
...
//#bugbug
//?? Onde est� essa fun��o ??
//N�o lembro onde est� a fun��o desse prot�tipo.
