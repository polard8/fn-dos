...
/*
 * bmpDirectDisplayBMP:
 *     Decodifica uma imagem BM que j� est� carregada na mem�ria. 
 ...
 * bmpDisplayBMP:
 *
 *     Decodifica uma imagem BMP que j� est� carregada na mem�ria. 
 *     (Pinta no backbuffer)
 *
 * IN:
 *     address = endere�o base
...
//320   - 32 bpp (True color, RGBA)	
    ...
    // #importante: A base � diferente para os tipos ?? 
