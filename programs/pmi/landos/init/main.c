...
// interna
// Uma interrupçao para habilitar as interrupçoes mascaraveis.
// So depois disso a interrupçao de timer vai funcionar.
...
//
    ...
    // #important
    // O task switching e o scheduler s� v�o funcionar
    // depois que o processo init habilitar as interrup��es.

    // #bugbug
    // O processo init est� rodando sozinho, mas tem seus ticks
    // contados at� que sofra preemp��o.
    // N�o queremos que ele sofra premp��o antes de habilitar
